...
class DefaultApi {
  ...
  Future<Response<void>> deleteItemItemsItemIdDelete({ 
    ...
    final _path = r'/items/{item_id}'.replaceAll('{' r'item_id' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getItemItemsGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Item>> getItemsItemsItemIdGet({ 
    required String itemId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> getTopGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postItemItemsPost({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [Item] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Item>> postItemsItemsItemIdPost({ 
    required String itemId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Item] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Item>> putItemItemsItemIdPut({ 
    required String itemId,
    required Item item,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    try {
      const _type = FullType(Item);
      _bodyData = _serializers.serialize(item, specifiedType: _type);
